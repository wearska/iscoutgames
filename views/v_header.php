                ...
                <div class="app-navigation app-bar-nav">
                    ...
                    <nav role="navigation">
                        <ul class="tabs-list nav-list">
                            <li class="tab active" data-title="Home" data-rel="views/home.php">Home</li>
                            <li class="tab" data-title="Submit" data-rel="views/submit.php">Submit</li>
                            <li class="tab" data-title="Games List" data-rel="views/gameslist.php">Games List</li>
                            <?php if(!empty($_SESSION[ 'LoggedIn']) && !empty($_SESSION[ 'Username'])) { ?>
                            <li class="tab" data-title="Log In" data-rel="views/account.php">Account</li>
                            <li class="tab" data-title="Sign Up" data-rel="views/logout.php">Log out</li>
                            <?php } else { ?>
